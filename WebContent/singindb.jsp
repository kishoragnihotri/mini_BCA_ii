...
try {
	...
	out.println("<h1>userid-: "+id+"</h1><br><h2>password-: "+password1+"</h2>");
	 PreparedStatement pstmt=con.prepareStatement("select  * from userdb where userid=? and password=?");
...
out.println("<a href='updateprofile.jsp'>Update Your Profile</a>");
out.println("<a href='deleteaccount.html'>delete Your Profile</a>");
	}
