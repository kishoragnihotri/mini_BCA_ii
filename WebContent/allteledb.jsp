...
try {
	...
	//	out.println(" :-"+id);
	      ResultSet resultset = statement.executeQuery("select * from tele");// where userid = '" + id + "'") ; 
...
<div id="footer"style="height:70px;margin-top:-100px;background:black"> TriMax	&copy; &nbsp;2018-2019&nbsp;<br>
